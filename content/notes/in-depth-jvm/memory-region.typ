...
#image("string-intern.png", alt: "String Intern")
...
#table(
  columns: 3,
  table.header([长度（32bit JVM 中）], [内容], [作用]),
...
#table(
  columns: 6,
  table.header([锁状态], [23bit], [2bit], [4bit], [1bit（是否为偏向锁）], [2bit（锁状态）]),
  [GC 标记], [空], [空], [空], [空], [11],
...
#image("mem-obj-ref.png", alt: "Memory Object Reference")
