...
#image("collection-interfaces.png", alt: "Java Collection Interfaces")
...
#table(
  ...
  [`V compute(K key, V value, BiFunction<...> remappingFunction)`],
  [（系列）如果存在 key 的对应 v，就对 v 和传入的 value 进行运算。如果运算结果是 null，就删除 Entry。],
