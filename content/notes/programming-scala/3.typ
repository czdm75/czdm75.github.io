...
#image("class-hierarchy.png", alt: "Scala类继承层级")
...
堆叠这种方式是解决多重继承的其中一个解决办法，可以参考 Python 使用的 #link("https://zh.wikipedia.org/wiki/C3%E7%BA%BF%E6%80%A7%E5%8C%96")[C3 线性化]来更好地理解它。由于 Scala使用了单继承 + trait 的方式，类的线性化方式比 C3 要简单。在 Java 中遇到方法冲突时，或者是 Scala 中的非 `override` 方法发生冲突时，我们会采用这样的方式：
...
#link(
  "https://g.gravizo.com/svg?%20digraph%20G%20%7B%20rankdir=BT%20Animal%20-%3E%20AnyRef%20-%3E%20Any%20Furry%20-%3E%20Animal%20HasLegs%20-%3E%20Animal%20FourLegged%20-%3E%20HasLegs%20Cat%20-%3E%20FourLegged%20Cat%20-%3E%20Furry%20Cat%20-%3E%20Animal%20%7D",
)[inheritance graph]
